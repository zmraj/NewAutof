...
async def index_files(bot, query):
    ...
    if int(from_user) not in ADMINS:
        await bot.send_message(int(from_user), f'Your Submission for indexing {chat} has been accepted by our 👮‍♀️ moderators 👮‍♀️ and will be added soon.', reply_to_message_id=int(lst_msg_id))
    await msg.edit(
        "Starting Indexing",
...
async def send_for_index(bot, message):
    ...
    await message.reply('ThankYou For the Contribution, Wait For My 👮‍♀️ Moderators 👮‍♀️ to verify the files.')
